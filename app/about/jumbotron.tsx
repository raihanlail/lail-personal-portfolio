...
const Jumbotron = () => {
  ...
  return (
    <section className='max-w-full -my-10 lg:h-[32rem] flex flex-col lg:flex-row mx-4 rounded-md sm:mx-8 md:mx-20 border-double border-color-bright'>
        ...
        <div className='w-full lg:w-1/2 flex items-center justify-center text-color-light overflow-hidden'>
            <motion.h1 variants={slideAnimation} initial="initial" animate="animate" className='text-3xl sm:text-4xl md:text-6xl lg:text-8xl 2xl:text-9xl py-8 lg:py-0 px-8 text-center font-bold'>
